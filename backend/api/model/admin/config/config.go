...
type BasicConfiguration struct {
	...
	CozeAPIToken            string         `thrift:"coze_api_token,4" form:"coze_api_token" json:"coze_api_token" query:"coze_api_token"`
...
func (p *BasicConfiguration) GetCozeAPIToken() (v string) {
...
func (p *BasicConfiguration) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("coze_api_token", thrift.STRING, 4); err != nil {
		goto WriteFieldBeginError
	}
